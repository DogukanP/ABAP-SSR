*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZDOP_MV_EMPDET2
*   generation date: 30.12.2021 at 15:43:33
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZDOP_MV_EMPDET2     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPDET2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZDOP_MV_EMPDET2_EXTRACT
TOTAL = ZDOP_MV_EMPDET2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPDET2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZDOP_MV_EMPDET2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZDOP_MV_EMPDET2_EXTRACT
TOTAL = ZDOP_MV_EMPDET2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZDOP_MV_EMPDET2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPDET2'
...
TOTAL = ZDOP_MV_EMPDET2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZDOP_MV_EMPDET2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZDOP_MV_EMPDET2-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPDET2'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZDOP_MV_EMPDET2-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZDOP_MV_EMPDET2_EXTRACT
TOTAL = ZDOP_MV_EMPDET2_TOTAL
