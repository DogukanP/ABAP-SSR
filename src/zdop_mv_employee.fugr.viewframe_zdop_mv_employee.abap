*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZDOP_MV_EMPLOYEE
*   generation date: 30.12.2021 at 14:37:55
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZDOP_MV_EMPLOYEE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPLOYEE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZDOP_MV_EMPLOYEE_EXTRACT
TOTAL = ZDOP_MV_EMPLOYEE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPLOYEE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZDOP_MV_EMPLOYEE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZDOP_MV_EMPLOYEE_EXTRACT
TOTAL = ZDOP_MV_EMPLOYEE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZDOP_MV_EMPLOYEE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPLOYEE'
...
TOTAL = ZDOP_MV_EMPLOYEE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZDOP_MV_EMPLOYEE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZDOP_MV_EMPLOYEE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZDOP_MV_EMPLOYEE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZDOP_MV_EMPLOYEE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZDOP_MV_EMPLOYEE_EXTRACT
TOTAL = ZDOP_MV_EMPLOYEE_TOTAL
